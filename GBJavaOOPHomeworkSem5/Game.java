package GBJavaOOPSeminars.GBJavaOOPHomeworkSem5;

import java.util.*;

import GBJavaOOPSeminars.GBJavaOOPHomeworkSem5.heroTypes.*;
...
public class Game {
    ...
    private static void view() {
        ...
        // System.out.print(darkSide.get(0).getDistance(whiteSide));
        tabSetter(darkSide.get(0).returnCondition().length(), l[0]);
        System.out.println(whiteSide.get(0).returnCondition());
        // System.out.println(whiteSide.get(0).getDistance(darkSide));
